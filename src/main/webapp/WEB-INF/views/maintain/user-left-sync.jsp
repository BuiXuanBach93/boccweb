...
<ul class="breadcrumb">
    ...
    <li><a href="<%= request.getContextPath()%>/backend/user-left-sync">手動退会処理</a></li>
</ul>
<script>var ctx = "${pageContext.request.contextPath}";</script>
<div class="home-page" style="margin-top: 20px">
    <div class="search-posts">
        <form:form class="" id="syncModel" role="form"
                   action="sync-user-process" method="POST" style="margin-top: 20px">
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-3 ">
                <input type="button" id="syncButton" class="btn btn-primary" data-toggle="modal"
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header bg-primary" style="border-top-left-radius: 0px; border-top-right-radius: 0px;">
                        <h4 class="modal-title"><i class="glyphicon glyphicon-question-sign"></i> 手動退会処理</h4>
                    </div>
