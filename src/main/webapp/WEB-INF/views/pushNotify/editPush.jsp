...
<form:form action="update-push" commandName="pushNotify" method="post" id="formEditPush">
            ...
            <div id="pushConfirmModal" class="modal fade modal-lg bg-primary-modal " role="document" style="margin: 30px auto; background: none;">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button id="btnConfirmEditPush" type="submit" class="btn btn-primary" data-confirm="Ok">OK</button>
...
<script>
    ...
    $('#btnConfirmEditPush').click(function () {
