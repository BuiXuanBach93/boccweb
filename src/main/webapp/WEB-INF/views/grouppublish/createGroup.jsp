...
<ul class="breadcrumb">
    ...
    <li><a href="<%= request.getContextPath()%>/backend/create-group-publish">法人グループ登録</a></li>
</ul>
<script>var ctx = "${pageContext.request.contextPath}";</script>
<form:form action="add-group-publish" modelAttribute="groupPublish" method="POST">
    <div class="box box-default" style="margin-top: 20px;">
        <div class="box-body" style="margin-top: 10px; padding: 10px">
            <div class="box-tools clearfix">
                <div class="form-group pull-left ">
                    <label>法人グループ登録　</label>
                </div>
            </div>
        ...
        <div class="box box-default">
            ...
            <div>
                ...
                <div>
                    <div class="group-detail col-md-4" style="margin-bottom: 10px;">
                        ...
                        <table id="groupDetailTable" border="1" style="margin-top: 10px">
                            ...
                            <tr>
                                <td><input style="padding-left: 10px;" maxlength="6" size=25 type="text"/></td>
                        ...
                        <div style="margin-top: 10px">
                            <button id="btnSavePublishGroup" type="button" class="btn btn-success">
...
<script>
    ...
    $("#btnOkCreateGroup").click(function() {
        ...
        $.ajax({
            type : "POST",
            contentType : "application/json",
            url : ctx + "/backend/add-group-publish",
            data : JSON.stringify(groupPublishRequest),
            timeout : 100000,
            success: function(response) {
                if(response.error == 1){
