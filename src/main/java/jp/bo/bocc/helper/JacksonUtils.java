...
public class JacksonUtils {
     ...
     * @throws Exception if there was an error converting the map-data into a json-string
     */
    public static String getJsonStringFromMap(Map<String, Object> dataMap) throws Exception {
     ...
     * @throws Exception if there was an error converting the json-string into map-data
     */
    @SuppressWarnings("unchecked")
    public static Map<String, Object> getJsonStringAsMap(String jsonResponse) throws Exception {
